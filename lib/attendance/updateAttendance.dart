...
class UpdateAttendance extends StatefulWidget {
  ...
  UpdateAttendance({Key key,this.department,this.year,this.semester,this.subject});
        ...
        child: FutureBuilder<List>(
          ...
          builder: (context, index){
            if(index.hasError)
              print("error !!");
            if(index.hasData)
              return StudentListItem(list: index.data,presentStudentIdRecord: _presentStudentIdRecord,);
            else
              return Center(
