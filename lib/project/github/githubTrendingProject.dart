...
class GithubTrendingProject extends StatefulWidget {
  @override
  _GithubTrendingProjectState createState() => _GithubTrendingProjectState();
}

class _GithubTrendingProjectState extends State<GithubTrendingProject> {
